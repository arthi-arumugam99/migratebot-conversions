      ...
      <div className="h-screen sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          ...
          <div className="my-10">
            <a
              href="vscode://"
              /* MIGRATED: outline-none → outline-hidden for accessibility; ring default changed to 1px so ring-2 keeps explicit width; ring-offset-2 flagged for review */
              className="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700 focus:outline-hidden focus:ring-2 focus:ring-indigo-700 focus:ring-offset-2"
            >
