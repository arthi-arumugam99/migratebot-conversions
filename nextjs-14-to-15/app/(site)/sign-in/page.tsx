...
export default function SignInPage() {
  ...
  const searchParams = useSearchParams(); // MIGRATED: useSearchParams() from next/navigation is already the correct client-side hook — no change needed for Next.js 15
