import { InferSelectModel } from "drizzle-orm"; // MIGRATED: replaced Address, User imports from @prisma/client with Drizzle InferSelectModel
import { users, addresses } from "../db/schema"; // MIGRATED: import schema tables for type inference
import {
  AddressResponse,
...
type Address = InferSelectModel<typeof addresses>; // MIGRATED: replaced Prisma Address type with Drizzle inferred type
