...
import { addresses } from "../db/schema"; // MIGRATED: import Drizzle schema table for type inference

// MIGRATED: replaced direct Prisma 'Address' type with Drizzle inferred type
